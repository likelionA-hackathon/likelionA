...
> 제품 소개는 [README](../README.md) 를 보세요. 이 문서는 로컬 개발·연동 설정용입니다.
> 처음 오셨으면 **[`ONBOARDING.md`](ONBOARDING.md)** 부터, 깃이 처음이면 **[`GIT.md`](GIT.md)** 도 같이.

PM Connector 를 로컬에서 띄우고, Notion·AI·Google OAuth 를 붙이는 방법입니다.
...
세팅을 순서대로 진단하고, 실패한 항목마다 뭘 해야 하는지 알려줍니다.
